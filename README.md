...
- 饥饿值降到 0 后进入挨饿状态，每小时损失 2 点健康，及时喂食仍可救回。额外的饥饿债仍会保留，因此一次 feed 不一定能脱离挨饿状态。
...
每 30,000 有效 token 消耗 1 点饥饿值，每个本地自然日最多产生 150 点饥饿消耗。工作量越大，消耗的体力越多；单次消耗在 0.5～8 之间。体力充足时，每次成功工作还会恢复 0.5 健康，每日最多恢复 3 点。
